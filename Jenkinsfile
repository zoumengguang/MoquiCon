...
pipeline {
   node {
	  ...
	  checkout(changelog: false, poll: false,
		 ...
		 doGenerateSubmoduleConfigurations: false,
		 extensions: [[$class: 'RelativeTargetDirectory', relativeTargetDir: "moqui-framework/runtime"]],
      ...
      for (comp in moquiComponents) {
         checkout(changelog: false, poll: false, scm:[$class: 'GitSCM',
	        branches: [[name: '*/master']],
	        extensions: [[$class: 'RelativeTargetDirectory', relativeTargetDir: "moqui-framework/runtime/component/${comp}"]],
	  ...
	  // Clone MoquiCon
	   checkout([$class: 'GitSCM',
	      branches: [[name: '*/master']],
	      extensions: [[$class: 'RelativeTargetDirectory', relativeTargetDir: "moqui-framework/runtime/component/MoquiCon"]], 
